...
import ReferenciaTema from "./ReferenciaTema.js";
...
export {
  ...
  Autor, ReferenciaAutor,
  PalabraClave, ReferenciaPalabra,
  Libro, Tesis, ArticuloRevista, PaginaWeb,
  FormatoCita, CitaGenerada,
  Area, Materia, Tema, ReferenciaTema,
};